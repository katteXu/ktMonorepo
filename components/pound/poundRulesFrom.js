...
//                 <Button style={{ width: 218 }} onClick={() => setShowChooseRouteModal(true)} ghost type="primary">
//                   <PlusOutlined />
//                   请选择专线
//                 </Button>
//               </Form.Item>
...
//         <div className={styles['titleSetting']}>磅差设置</div>
...
//             },
//           ]}>
//           <Input placeholder="请输入0~1之间的数字" suffix="吨" disabled={reduceCheck ? true : false} />
//         </Form.Item>
...
//                   },
//                 ]}>
//                 <Input placeholder="" style={{ width: 50, margin: '0 4px' }} disabled={reduceCheck ? false : true} />
//               </Form.Item>
...
//         <ChooseRouteModal handleSureChooseRoute={handleSureChooseRoute} />
//       </Drawer>
//     </div>
//   );
// };
...
import { Input, Button, Form, Radio, Select, Drawer, Divider, Checkbox } from 'antd';
import { useState, useEffect } from 'react';
import { PlusOutlined } from '@ant-design/icons';
import styles from './styles.less';
import ChooseRouteModal from './chooseRouteModal';
