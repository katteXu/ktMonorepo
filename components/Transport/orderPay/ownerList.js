...
import BatchConfirm from '@components/Transport/orderPay/personalBatchConfirm';
...
class OwnerList extends PureComponent {
  ...
  // 批量结算
  submit = () => {
    console.log('owner', this.state.hasPayPass);
    // 未设置支付密码;
        ...
        <Search onSearch={this.query} onReset={this.reset} simple>
          <Search.Item label="承运时间" br>
            <DatePicker.RangePicker
              ...
              style={{ width: 400 }}></DatePicker.RangePicker>
          </Search.Item>
