    ...
    <div>
      <Form
        ...
        <Form.Item
          ...
          <AreaPicker useCode={true} style={{ width: 264 }} />
        </Form.Item>
        ...
        <Form.Item
          ...
          <Input placeholder="请输入详细地址" onChange={() => setAddressRules({})} style={{ width: 400 }} />
        </Form.Item>
