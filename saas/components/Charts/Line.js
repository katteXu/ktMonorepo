...
// 生成配置
const getOpt = (data, xAxis, showLegend, customlineStyle) => {
 ...
 * xAxis:[]
 */
const Line = ({ data = {}, xAxis, size, showLegend, customlineStyle }) => {
  const [option, setOption] = useState({});

  useEffect(() => {
    const option = getOpt(data, xAxis, showLegend, customlineStyle);
    setOption(option);
  }, [data]);
