...
const PoundRailWay = props => {
  ...
  return (
    <Layout {...routeView}>
      <Content>
        <section>
          <Button type="primary" style={{ marginBottom: 16 }} onClick={() => router.push('/railWay/pound/create')}>
            创建专线
          </Button>
        ...
        {/* <header>
          专线列表
        <Button type="primary" style={{}} onClick={() => router.push('/railWay/pound/create')}>
          创建专线
        </Button>
        </header> */}
